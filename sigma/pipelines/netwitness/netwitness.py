...
def netwitness_example():      # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="RSA Netwitness example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"netwitness_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="netwitness_field_mapping",
